...
const UserOrdersPage = () => {
  ...
  return (
    <div className="min-h-screen bg-[#FFEFD5] text-[#2F2F2F] font-sans">
      ...
      >
            ...
            return (
              ...
              >
                ...
                <div className="space-y-2">
                  ...
                  <div className="text-sm text-gray-500">Ngày đặt: {orderDate}</div>
                  <div className="text-sm text-gray-700">
                    Địa chỉ: {`${address.addressDetail}, ${address.ward}, ${address.district}, ${address.province}`}
                  </div>
                  <div className="text-sm text-gray-700">
        ...
        {selectedOrder && (
          <div className="fixed inset-0 bg-black bg-opacity-40 flex items-center justify-center !m-0 z-50">
